...
// ── USER ACCOUNTS ─────────────────────────────────────────────────────
var USERS = [
    { id: "potent", name: "POTENT", role: "owner", password: "POTENTADMIN0421", emoji: "👑", access: ["quote", "jobs", "exceptions", "reports", "advanced", "carriers", "expenses", "accounts", "sales", "audit", "calendar", "driver", "driverapp", "ai"] },
    { id: "dispatch1", name: "Dispatch 1", role: "dispatch", password: "DISPATCH1PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp"] },
    { id: "dispatch2", name: "Dispatch 2", role: "dispatch", password: "DISPATCH2PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp"] },
    { id: "driver", name: "Driver", role: "driver", password: "DRIVERPL", emoji: "🚐", access: ["driver", "driverapp"] },
];
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, color: C.white, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { borderBottom: "1px solid " + C.border, padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: C.black, zIndex: 100 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                React.createElement("div", { style: { display: "flex", gap: 3, background: C.surface, borderRadius: 9, padding: 3, flexWrap: "wrap" } }, [["quote", "📞 Quote"], ["jobs", "📋 Jobs"], ["exceptions", "🚨 Alerts"], ["reports", "📊 Reports"], ["advanced", "📈 Analytics"], ["carriers", "🤝 Carriers"], ["expenses", "💸 Expenses"], ["accounts", "🏢 Accounts"], ["sales", "🏆 Sales"], ["audit", "👁 Audit"], ["calendar", "📅 Cal"], ["driver", "🚐 Driver"], ["driverapp", "🚐 Driver App"], ["ai", "🤖 AI Docs"]].filter(function (item) {
...
function WaitlistPage() {
    ...
    function submit() {
        ...
        }).catch(function () { setLoading(false); setErr(true); setTimeout(function () { setErr(false); }, 3000); });
    }
    if (sent)
        return React.createElement("div", { style: { minHeight: "100vh", background: C.black, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
            React.createElement("div", { style: { maxWidth: 480, textAlign: "center" } },
                React.createElement("div", { style: { fontSize: 60, marginBottom: 16 } }, "\uD83C\uDF89"),
                React.createElement("div", { style: { fontSize: 28, fontWeight: 900, color: C.white, marginBottom: 10 } }, "Application Received!"),
                React.createElement("div", { style: { fontSize: 14, color: C.dim, lineHeight: 1.8, marginBottom: 24 } },
                    "We've received your application for ",
                    React.createElement("strong", { style: { color: C.orange } }, f.company_name),
                    ". Our team reviews every application personally and will reach out within 1-2 business days."),
                React.createElement("div", { style: { background: C.card, border: "1px solid " + C.border, borderRadius: 12, padding: "20px", textAlign: "left" } },
                    React.createElement("div", { style: { fontSize: 12, color: C.dim, lineHeight: 2 } },
                        React.createElement("div", null, "\u2705 Application received"),
                        React.createElement("div", null, "\u23F3 Personal review (1-2 business days)"),
                        React.createElement("div", null, "\uD83D\uDCDE We'll call to discuss your operation"),
                        React.createElement("div", null, "\uD83D\uDE80 Onboarding & setup if approved")))));
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { background: "linear-gradient(180deg,#0d0d0d,#080808)", borderBottom: "1px solid " + C.border, padding: "50px 20px", textAlign: "center" } },
            React.createElement("div", { style: { fontSize: 11, color: C.orange, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", marginBottom: 14 } }, "PRIVATE ACCESS \u00B7 BY APPLICATION ONLY"),
            React.createElement("div", { style: { fontSize: 46, fontWeight: 900, color: C.white, lineHeight: 1.1, marginBottom: 12 } },
                "POTENT ",
                React.createElement("span", { style: { color: C.orange } }, "OS")),
            React.createElement("div", { style: { fontSize: 16, color: C.dim, maxWidth: 520, margin: "0 auto 28px", lineHeight: 1.7 } }, "The same operations system that runs Potent Logistics \u2014 now available to select logistics companies."),
            React.createElement("div", { style: { display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap", marginBottom: 36 } }, ["Full Booking System", "Driver Settlements", "Fleet Maintenance", "IFTA Reports", "Compliance Tracking", "CRM Pipeline", "QuickBooks Export"].map(function (feat) {
                return React.createElement("span", { key: feat, style: { background: C.orange + "18", border: "1px solid " + C.orange + "44", color: C.orange, borderRadius: 20, padding: "5px 13px", fontSize: 11, fontWeight: 600 } },
                    "\u2713 ",
                    feat);
            })),
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(170px,1fr))", gap: 10, maxWidth: 580, margin: "0 auto" } }, [["🟢 Starter", "$3,500", "1-10 users", "$149/mo support"], ["🔵 Growth", "$6,500", "11-50 users", "$249/mo support"], ["🟣 Fleet", "$12,500", "51-150+ users", "$399/mo support"]].map(function (p) {
                return React.createElement("div", { key: p[0], style: { background: C.card, border: "1px solid " + C.border, borderRadius: 12, padding: "16px", textAlign: "center" } },
                    React.createElement("div", { style: { fontSize: 13, fontWeight: 800, color: C.white, marginBottom: 4 } }, p[0]),
                    React.createElement("div", { style: { fontSize: 24, fontWeight: 900, color: C.orange, marginBottom: 4 } }, p[1]),
                    React.createElement("div", { style: { fontSize: 10, color: C.dim, lineHeight: 1.6 } },
                        p[2],
                        React.createElement("br", null),
                        p[3]));
            }))),
        React.createElement("div", { style: { padding: "40px 20px", maxWidth: 580, margin: "0 auto" } },
            React.createElement("div", { style: { textAlign: "center", marginBottom: 28 } },
                React.createElement("div", { style: { fontSize: 22, fontWeight: 900, color: C.white, marginBottom: 8 } }, "Apply for Early Access"),
                React.createElement("div", { style: { fontSize: 13, color: C.dim, lineHeight: 1.7 } }, "We review every application personally. We're selective \u2014 we want serious operators who will grow with the platform.")),
            React.createElement("div", { style: { background: C.card, border: "1px solid " + C.border, borderRadius: 14, padding: "22px 20px" } },
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 12px" } },
                    React.createElement(TxtIn, { label: "Company Name *", value: f.company_name, onChange: function (v) { set("company_name", v); } }),
                    React.createElement(TxtIn, { label: "Your Name *", value: f.contact_name, onChange: function (v) { set("contact_name", v); } })),
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 12px" } },
                ...
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0 12px" } },
                    React.createElement(TxtIn, { label: "# of Trucks", value: f.truck_count, onChange: function (v) { set("truck_count", v); }, type: "number" }),
                    React.createElement(TxtIn, { label: "# of Drivers", value: f.driver_count, onChange: function (v) { set("driver_count", v); }, type: "number" }),
                    React.createElement(TxtIn, { label: "State", value: f.state, onChange: function (v) { set("state", v); }, placeholder: "GA" })),
                React.createElement(Lbl, null, "Primary Service Type"),
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 14 } }, ["Courier & Delivery", "Freight / Trucking", "Junk Removal", "Property Services", "Mixed Services"].map(function (s) {
                    return React.createElement("div", { key: s, onClick: function () { set("service_type", f.service_type === s ? "" : s); }, style: { border: "1px solid " + (f.service_type === s ? C.orange : C.border), borderRadius: 7, padding: "6px 12px", cursor: "pointer", background: f.service_type === s ? C.orangeSoft : "transparent", fontSize: 11, fontWeight: 600, color: f.service_type === s ? C.orange : C.dim } }, s);
                })),
                React.createElement(Lbl, null, "Monthly Revenue Range"),
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 14 } }, ["Under $10K", "$10K-$25K", "$25K-$50K", "$50K-$100K", "Over $100K"].map(function (r) {
                    return React.createElement("div", { key: r, onClick: function () { set("monthly_revenue", f.monthly_revenue === r ? "" : r); }, style: { border: "1px solid " + (f.monthly_revenue === r ? C.orange : C.border), borderRadius: 7, padding: "6px 12px", cursor: "pointer", background: f.monthly_revenue === r ? C.orangeSoft : "transparent", fontSize: 11, fontWeight: 600, color: f.monthly_revenue === r ? C.orange : C.dim } }, r);
                })),
                React.createElement(Lbl, null, "How did you hear about us?"),
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 14 } }, ["Referral", "Social Media", "Google", "Word of Mouth", "Other"].map(function (h) {
                    return React.createElement("div", { key: h, onClick: function () { set("how_heard", f.how_heard === h ? "" : h); }, style: { border: "1px solid " + (f.how_heard === h ? C.orange : C.border), borderRadius: 7, padding: "6px 12px", cursor: "pointer", background: f.how_heard === h ? C.orangeSoft : "transparent", fontSize: 11, fontWeight: 600, color: f.how_heard === h ? C.orange : C.dim } }, h);
                })),
                React.createElement(TxtIn, { label: "Tell us about your operation (optional)", value: f.notes, onChange: function (v) { set("notes", v); }, placeholder: "What challenges are you trying to solve? What software are you using now?", rows: 3 }),
                err && React.createElement("div", { style: { background: C.red + "12", border: "1px solid " + C.red + "33", borderRadius: 8, padding: "10px 14px", marginBottom: 12, fontSize: 12, color: C.red } }, "Something went wrong. Please try again or call us directly."),
                React.createElement(Btn, { onClick: submit, disabled: !f.company_name || !f.contact_name || !f.email || loading, style: { width: "100%", padding: "14px", fontSize: 14 } }, loading ? "Submitting..." : "Submit Application 🚀"),
                React.createElement("div", { style: { fontSize: 10, color: C.faint, textAlign: "center", marginTop: 10, lineHeight: 1.6 } },
                    "We review all applications within 1-2 business days.",
                    React.createElement("br", null),
                    "Not all applicants will be accepted.")),
            React.createElement("div", { style: { textAlign: "center", marginTop: 24, fontSize: 12, color: C.dim } },
                "Questions? Call us at ",
                React.createElement("a", { href: "tel:+17706484228", style: { color: C.orange, textDecoration: "none" } }, "(770) 648-4228"))));
}
