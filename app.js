...
function BookingView(props) {
    ...
    var [form, setForm] = useState({ name: "", phone: "", origin: "", destination: "", miles: "", zone: props.preZone || "local", speed: "standard", itemSize: "", helper: false, weightTier: "light", extraStop: false, readyConfirm: false, isBusiness: false, payment: "cash", discreet: false, notes: "", date: "", timeSlot: "" });
    ...
    function reset() {
        ...
        setForm({ name: "", phone: "", origin: "", destination: "", miles: "", zone: props.preZone || "local", speed: "standard", itemSize: "", helper: false, weightTier: "light", extraStop: false, readyConfirm: false, isBusiness: false, payment: "cash", discreet: false, notes: "", date: "", timeSlot: "" });
        setQuote(null);
        setJobId(null);
    }
        ...
        return React.createElement("div", { style: { maxWidth: 520, margin: "0 auto" } },
            ...
            React.createElement(Card, null,
                ...
                React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 4 } },
                    ...
                    React.createElement(Btn, { onClick: function () { setStep(3); }, disabled: !form.name || !form.phone || !form.origin || !form.destination || !form.readyConfirm || !form.date || !form.timeSlot || (isMileageSvc && !(miles > 0)), style: { flex: 2 } }, "Continue \u2192"))));
    if (step === 3)
        return React.createElement("div", { style: { maxWidth: 520, margin: "0 auto" } },
    ...
    if (step === 5) {
        ...
        return React.createElement("div", { style: { maxWidth: 480, margin: "0 auto" } },
            React.createElement(Card, { style: { textAlign: "center" } },
                ...
                form.payment === "cash" && React.createElement("div", { style: { background: C.green + "12", border: "1px solid " + C.green + "33", borderRadius: 9, padding: "10px 14px", marginBottom: 10, fontSize: 12, color: C.green } }, "\uD83D\uDCB5 Cash due in full at pickup \u2014 exact amount appreciated. Your 10% discount is applied."),
                form.payment === "card" && React.createElement("div", { style: { background: C.green + "12", border: "1px solid " + C.green + "33", borderRadius: 9, padding: "10px 14px", marginBottom: 10, fontSize: 12, color: C.green } }, "\uD83D\uDCB3 Payment confirmed online \u2014 your card has been charged. Receipt sent to your phone."),
...
function NewJobModal(props) {
    var [f, setF] = useState({ customer: "", phone: "", origin: "", destination: "", miles: "", serviceId: "delivery", zone: "local", speed: "standard", payment: "cash", discreet: false, notes: "", helper: false, weightTier: "light", priceTier: "standard", helperHours: "0", fuel: "30" });
    ...
    function submit() {
        if (!f.customer || !f.origin || !f.destination || (isMileageSvc && !(miles > 0)))
            return;
    ...
    return React.createElement("div", { onClick: function (e) { if (e.target === e.currentTarget)
        ...
        React.createElement("div", { style: { background: C.card, borderRadius: "14px 14px 0 0", padding: "22px 18px 32px", width: "100%", maxWidth: 540, maxHeight: "90vh", overflowY: "auto", fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 8 } },
                ...
                React.createElement(Btn, { onClick: submit, disabled: !f.customer || !f.origin || !f.destination || (isMileageSvc && !(miles > 0)), style: { flex: 2 } }, "Save Job \u2713"))));
}
// ── JOBS DASHBOARD ────────────────────────────────────────────────
