...
var USERS = [
    ...
    { id: "dispatch1", name: "Dispatch 1", role: "dispatch", password: "DISPATCH1PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch2", name: "Dispatch 2", role: "dispatch", password: "DISPATCH2PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch3", name: "Dispatch 3", role: "dispatch", password: "DISPATCH3PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch4", name: "Dispatch 4", role: "dispatch", password: "DISPATCH4PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch5", name: "Dispatch 5", role: "dispatch", password: "DISPATCH5PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch6", name: "Dispatch 6", role: "dispatch", password: "DISPATCH6PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch7", name: "Dispatch 7", role: "dispatch", password: "DISPATCH7PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch8", name: "Dispatch 8", role: "dispatch", password: "DISPATCH8PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch9", name: "Dispatch 9", role: "dispatch", password: "DISPATCH9PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch10", name: "Dispatch 10", role: "dispatch", password: "DISPATCH10PL", emoji: "📞", commission: 0.125, commLogistics: 0.125, commOS: 0.10, commLoadboard: 0.10, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
...
function useTranslations() {
    ...
    function changeLang(l) { setLang(l); setLangState(l); }
                ...
                (isLoadSizeSvc || isCleanoutSvc) ? React.createElement("div", null,
                    ...
                    React.createElement("div", { style: { marginBottom: 10 } },
                        ...
                        React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } },
                            React.createElement("input", { value: form.originStreet || "", onChange: function (e) { var s = e.target.value; set("originStreet", s); set("origin", s + ", " + (form.originCity || "") + ", " + (form.originState || "GA")); }, placeholder: true, t: true }),
                            "(\"streetAddress\") style=",
                            { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" },
                            "/>",
...
var TAB_GROUPS = [
    { label: "⚡ Ops", color: "#4299E1", tabs: [["quote", "📞 Quote"], ["jobs", "📋 Jobs"], ["exceptions", "🚨 Alerts"], ["calendar", "📅 Calendar"]] },
    { label: "📋 Leads", color: "#1DB954", tabs: [["leads", "📋 Leads"], ["activity", "👥 Activity"], ["leaderboard", "🏆 Board"]] },
    { label: "🚐 Driver", color: "#9F7AEA", tabs: [["driver", "🚐 Driver"], ["driverapp", "🚐 Driver App"]] },
    { label: "📊 Reports", color: C.orange, tabs: [["reports", "📊 Reports"], ["advanced", "📈 Analytics"], ["sales", "🏆 Sales"]] },
    { label: "💼 Biz", color: "#F6E05E", tabs: [["carriers", "🤝 Carriers"], ["expenses", "💸 Expenses"], ["accounts", "🏢 Accounts"], ["audit", "👁 Audit"]] },
    { label: "👥 Team", color: "#FC8181", tabs: [["payroll", "💰 Payroll"], ["ai", "🤖 AI Docs"]] },
    { label: "🎬 More", color: "#888", tabs: [["demo", "🎬 Demo"]] },
];
function TabNav({ tab, setTab, currentUser }) {
    ...
    var activeGroup = TAB_GROUPS.find(function (g) { return g.tabs.some(function (t) { return t[0] === tab; }); }) || null;
    ...
    return React.createElement("div", { style: { display: "flex", gap: 4, alignItems: "center", flexWrap: "nowrap" } },
        React.createElement("div", { style: { background: C.orange, borderRadius: 7, padding: "5px 10px", fontSize: 11, fontWeight: 700, color: "#000", whiteSpace: "nowrap", maxWidth: 120, overflow: "hidden", textOverflow: "ellipsis" } }, TAB_GROUPS.flatMap(function (g) { return g.tabs; }).find(function (t) { return t[0] === tab; })?.[1] || tab),
        React.createElement("div", { style: { display: "flex", gap: 3, position: "relative" } }, TAB_GROUPS.map(function (g, gi) {
            var accessible = g.tabs.filter(function (t) { return hasAccess(t[0]); });
                ...
                return React.createElement("div", { key: u.id, style: { background: terminated ? C.surface + "88" : C.surface, border: "1px solid " + (terminated ? C.faint : C.border), borderRadius: 8, padding: "10px 12px", marginBottom: 8, opacity: terminated ? 0.6 : 1 } },
                    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 10px", marginBottom: 8 } },
                        React.createElement("div", null,
                            ...
                            React.createElement("input", { value: emp.name || u.name, onChange: function (e) { setEmpField(u.id, "name", e.target.value); }, style: { background: C.card, border: "1px solid " + C.border, borderRadius: 6, color: C.white, padding: "6px 8px", fontSize: 12, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" } })),
                        React.createElement("div", null,
                    ...
                    React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } },
                        ...
                        React.createElement("div", { style: { marginLeft: "auto", display: "flex", gap: 6 } },
                            !terminated && React.createElement("button", { onClick: function () { if (confirm("Mark " + getEmpName(u) + " as No Longer With Us?"))
                            ...
                            terminated && React.createElement("span", { style: { fontSize: 10, color: C.red, fontWeight: 700 } }, "NO LONGER WITH US"))));
            })),
