...
var USERS = [
    { id: "potent", name: "POTENT", role: "owner", password: "POTENTADMIN0421", emoji: "👑", access: ["quote", "jobs", "exceptions", "reports", "advanced", "carriers", "expenses", "accounts", "sales", "audit", "calendar", "driver", "driverapp", "ai", "demo", "leads", "activity", "leaderboard"] },
    { id: "dispatch1", name: "Dispatch 1", role: "dispatch", password: "DISPATCH1PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch2", name: "Dispatch 2", role: "dispatch", password: "DISPATCH2PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch3", name: "Dispatch 3", role: "dispatch", password: "DISPATCH3PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch4", name: "Dispatch 4", role: "dispatch", password: "DISPATCH4PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch5", name: "Dispatch 5", role: "dispatch", password: "DISPATCH5PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch6", name: "Dispatch 6", role: "dispatch", password: "DISPATCH6PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch7", name: "Dispatch 7", role: "dispatch", password: "DISPATCH7PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch8", name: "Dispatch 8", role: "dispatch", password: "DISPATCH8PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch9", name: "Dispatch 9", role: "dispatch", password: "DISPATCH9PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, color: C.white, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { borderBottom: "1px solid " + C.border, padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: C.black, zIndex: 100 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                React.createElement("div", { style: { display: "flex", gap: 3, background: C.surface, borderRadius: 9, padding: 3, flexWrap: "wrap" } }, [["quote", "📞 Quote"], ["jobs", "📋 Jobs"], ["exceptions", "🚨 Alerts"], ["reports", "📊 Reports"], ["advanced", "📈 Analytics"], ["carriers", "🤝 Carriers"], ["expenses", "💸 Expenses"], ["accounts", "🏢 Accounts"], ["sales", "🏆 Sales"], ["audit", "👁 Audit"], ["calendar", "📅 Cal"], ["driver", "🚐 Driver"], ["driverapp", "🚐 Driver App"], ["ai", "🤖 AI Docs"], ["leads", "📋 Leads"], ["activity", "👥 Activity"], ["leaderboard", "🏆 Board"], ["demo", "🎬 Demo"]].filter(function (item) {
...
function LeaderBoard(props) {
    ...
    var reps = Object.values(repStats).map(function (r) {
        ...
        var score = (r.booked || 0) * 50 + (r.interested || 0) * 20 + (r.calls || 0) * 1 + (r.followUps || 0) * 5;
    ...
    return React.createElement("div", { style: { maxWidth: 760, margin: "0 auto", fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        ...
        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 10, marginBottom: 20 } }, [["Total Calls", totalCalls, C.white], ["Booked", totalBooked, "#1DB954"], ["Team Revenue", "$" + totalRevenue.toLocaleString(), C.orange]].map(function (s) {
            ...
            React.createElement("div", { style: { display: "flex", gap: 10, justifyContent: "center", alignItems: "flex-end" } },
                ...
                React.createElement("div", { style: { textAlign: "center", flex: 1, maxWidth: 220 } },
                    ...
                    React.createElement("div", { style: { background: "linear-gradient(180deg,#2a2400,#1a1a00)", border: "2px solid " + C.orange, borderRadius: 12, padding: "20px 12px", borderBottom: "4px solid " + C.orange } },
                        ...
                        React.createElement("div", { style: { fontSize: 11, color: C.dim, marginTop: 4 } },
                            reps[0].calls,
                            " calls \u00B7 ",
                            reps[0].booked || 0,
                            " booked"),
                        (reps[0].revenue || 0) > 0 && React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: C.green, marginTop: 4 } },
                            "$",
        ...
        React.createElement(Card, { style: { padding: 0, overflow: "hidden" } },
            React.createElement("div", { style: { padding: "12px 16px", borderBottom: "1px solid " + C.border } },
                ...
                React.createElement("div", { style: { fontSize: 10, color: C.dim, marginTop: 2 } }, "Score = Booked(\u00D750) + Interested(\u00D720) + Follow-Up(\u00D75) + Calls(\u00D71)")),
            loading ? React.createElement("div", { style: { padding: 20, textAlign: "center", color: C.dim, fontSize: 12 } }, "Loading...")
                : reps.length === 0 ? React.createElement("div", { style: { padding: 20, textAlign: "center", color: C.dim, fontSize: 12 } }, "No activity logged yet. Start calling leads to appear on the board.")
                    : reps.map(function (rep, i) {
                        ...
                        return React.createElement("div", { key: rep.name, style: { display: "grid", gridTemplateColumns: "36px 1fr 60px 60px 70px 80px", alignItems: "center", gap: 8, padding: "12px 16px", borderBottom: "1px solid " + C.border, background: isMe ? C.orange + "08" : "transparent" } },
        ...
        React.createElement("div", { style: { marginTop: 16, background: C.surface, border: "1px solid " + C.border, borderRadius: 10, padding: "12px 16px" } },
            ...
            React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 } }, [["📞 Call logged", "1 pt"], ["📅 Follow-up set", "5 pts"], ["✅ Interested", "20 pts"], ["🎉 Booked!", "50 pts"], ["💼 Job booked", "50 pts"], ["💰 Revenue", "1 pt per $10"]].map(function (item) {
