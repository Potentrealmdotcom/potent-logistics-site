...
function LeaderBoard(props) {
    ...
    return React.createElement("div", { style: { maxWidth: 760, margin: "0 auto", fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        ...
        isOwner && showBonus && React.createElement("div", { style: { background: C.card, border: "1px solid " + C.orange + "44", borderRadius: 10, padding: "14px", marginBottom: 16 } },
            ...
            Object.keys(bonusPoints).length > 0 && React.createElement("div", null,
                React.createElement("div", { style: { fontSize: 10, color: C.dim, marginBottom: 6 } }, "Current bonus points:"),
                Object.entries(bonusPoints).map(function(bp){
                    return React.createElement("div", { key: bp[0], style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "5px 0", borderBottom: "1px solid " + C.border } },
                        React.createElement("span", { style: { fontSize: 11, color: C.white } }, bp[0]),
                        React.createElement("span", { style: { fontSize: 11, color: C.orange, fontWeight: 700 } }, "+" + bp[1] + " pts"),
                        React.createElement("button", { onClick: function(){removeBonus(bp[0]);}, style: { background: "none", border: "none", color: C.red, cursor: "pointer", fontSize: 12, fontFamily: "inherit" } }, "✕")
                    );
                })
            )
        ),
