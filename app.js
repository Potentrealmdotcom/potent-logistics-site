...
var USERS = [
    { id: "potent", name: "POTENT", role: "owner", password: "POTENTADMIN0421", emoji: "👑", commission: 0, access: ["quote", "jobs", "exceptions", "reports", "advanced", "carriers", "expenses", "accounts", "sales", "audit", "calendar", "driver", "driverapp", "ai", "demo", "leads", "activity", "leaderboard", "payroll"] },
    { id: "dispatch1", name: "Dispatch 1", role: "dispatch", password: "DISPATCH1PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch2", name: "Dispatch 2", role: "dispatch", password: "DISPATCH2PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch3", name: "Dispatch 3", role: "dispatch", password: "DISPATCH3PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch4", name: "Dispatch 4", role: "dispatch", password: "DISPATCH4PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch5", name: "Dispatch 5", role: "dispatch", password: "DISPATCH5PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch6", name: "Dispatch 6", role: "dispatch", password: "DISPATCH6PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch7", name: "Dispatch 7", role: "dispatch", password: "DISPATCH7PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch8", name: "Dispatch 8", role: "dispatch", password: "DISPATCH8PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch9", name: "Dispatch 9", role: "dispatch", password: "DISPATCH9PL", emoji: "📞", commission: 0.125, access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "dispatch10", name: "Dispatch 10", role: "dispatch", password: "DISPATCH10PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads", "leaderboard"] },
    { id: "driver", name: "Driver", role: "driver", password: "DRIVERPL", emoji: "🚐", commission: 0, access: ["driver", "driverapp", "payroll"] },
];
                ...
                (isLoadSizeSvc || isCleanoutSvc) ? React.createElement("div", null,
                    ...
                    React.createElement("div", { style: { marginBottom: 10 } },
                        ...
                        React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } },
                            React.createElement("input", { value: form.originStreet || "", onChange: function (e) { set("originStreet", e.target.value); setTimeout(function () { if (form.originStreet && form.originCity && form.originState) {
                                    set("origin", (form.originStreet || "") + ", " + (form.originCity || "") + ", " + (form.originState || ""));
                                } }, 100); }, placeholder: "Street Address (e.g. 2089 Christian Cir SE)", style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" } }),
                            React.createElement("div", { style: { display: "flex", gap: 6 } },
                                React.createElement("input", { value: form.originCity || "", onChange: function (e) { set("originCity", e.target.value); }, placeholder: "City (e.g. Conyers)", style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, flex: 2, outline: "none", fontFamily: "inherit", boxSizing: "border-box" } }),
                                React.createElement("input", { value: form.originState || "", onChange: function (e) { set("originState", e.target.value.toUpperCase().substring(0, 2)); }, placeholder: "State (GA)", maxLength: 2, style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, flex: 1, outline: "none", fontFamily: "inherit", boxSizing: "border-box", textTransform: "uppercase" } })))),
                    React.createElement("div", { style: { marginBottom: 10 } },
                        React.createElement(Lbl, null, "Drop-Off Address"),
                        React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } },
                            React.createElement("input", { value: form.destStreet || "", onChange: function (e) { set("destStreet", e.target.value); }, placeholder: "Street Address (e.g. 44 Howes Rd)", style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" } }),
                            React.createElement("div", { style: { display: "flex", gap: 6 } },
                                React.createElement("input", { value: form.destCity || "", onChange: function (e) { set("destCity", e.target.value); }, placeholder: "City (e.g. South Yarmouth)", style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, flex: 2, outline: "none", fontFamily: "inherit", boxSizing: "border-box" } }),
                                React.createElement("input", { value: form.destState || "", onChange: function (e) { set("destState", e.target.value.toUpperCase().substring(0, 2)); }, placeholder: "State (MA)", maxLength: 2, style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 9, color: C.white, padding: "11px 14px", fontSize: 14, flex: 1, outline: "none", fontFamily: "inherit", boxSizing: "border-box", textTransform: "uppercase" } })))),
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, color: C.white, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { borderBottom: "1px solid " + C.border, padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: C.black, zIndex: 100 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                React.createElement("div", { style: { display: "flex", gap: 3, background: C.surface, borderRadius: 9, padding: 3, flexWrap: "wrap" } }, [["quote", "📞 Quote"], ["jobs", "📋 Jobs"], ["exceptions", "🚨 Alerts"], ["reports", "📊 Reports"], ["advanced", "📈 Analytics"], ["carriers", "🤝 Carriers"], ["expenses", "💸 Expenses"], ["accounts", "🏢 Accounts"], ["sales", "🏆 Sales"], ["audit", "👁 Audit"], ["calendar", "📅 Cal"], ["driver", "🚐 Driver"], ["driverapp", "🚐 Driver App"], ["ai", "🤖 AI Docs"], ["leads", "📋 Leads"], ["activity", "👥 Activity"], ["leaderboard", "🏆 Board"], ["payroll", "💰 Payroll"], ["demo", "🎬 Demo"]].filter(function (item) {
        ...
        React.createElement("div", { style: { padding: "20px 14px 60px", maxWidth: 740, margin: "0 auto" } },
            ...
            tab === "driverapp" && React.createElement(EnhancedDriverApp, { jobs: props.jobs, onUpdateStatus: props.onUpdateStatus }),
...
function Root() {
    ...
    } setJobs(function (p) { return p.map(function (j) { return j.id === id ? Object.assign({}, j, { status: s }) : j; }); }); syncStatusToSupabase(id, s); }
    function login(user) {
        setIsAdmin(true);
        setCurrentUser(user);
        saveAuth(true);
        ...
        job && React.createElement("div", null,
            React.createElement(Card, { style: { marginBottom: 12 } },
                ...
                React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 12 } }, STATUS_FLOW.map(function (s) {
                    var sc = STATUS_COLOR[s] || C.dim;
                    return React.createElement("button", { key: s, onClick: function () { onUpdateStatus(job.id, s); }, style: { border: "1px solid " + (job.status === s ? sc : C.border), borderRadius: 6, padding: "6px 10px", cursor: "pointer", background: job.status === s ? sc + "22" : C.surface, color: job.status === s ? sc : C.dim, fontSize: 11, fontWeight: 600, fontFamily: "inherit" } }, s);
                })),
...
function AIDocumentExtractor(props) {
    ...
    var DOC_TYPES = [
        ...
        { id: "bol", label: "📋 Bill of Lading", desc: "Extract BOL details" },
        { id: "receipt", label: "🧾 Receipt / Expense", desc: "Extract expense data" },
...
function DemoDataLoader(props) {
    ...
    var revenue = demoJobs.reduce(function (s, j) { return s + j.finalPrice; }, 0);
    return React.createElement("div", { style: { maxWidth: 600, margin: "0 auto" } },
...
function LeadsBoard(props) {
    ...
    function logCall(lead, outcomeKey) {
        ...
        var updated = { status: STATUS_FROM_OUTCOME[outcomeKey] || lead.status, notes_log: newLog, follow_up_date: outcomeKey === "follow_up" ? followDate : lead.follow_up_date };
    ...
    if (selected) {
        ...
        return React.createElement("div", { style: { maxWidth: 560, margin: "0 auto" } },
            React.createElement("button", { onClick: function () { setSelected(null); setNote(""); setFollowDate(""); }, style: { background: "none", border: "none", color: C.dim, fontSize: 13, cursor: "pointer", marginBottom: 12, display: "flex", alignItems: "center", gap: 6 } }, "\u2190 Back to list"),
            React.createElement("div", { style: { background: "#F5F1E8", color: "#0B0E14", borderRadius: 12, padding: "20px", marginBottom: 16 } },
                React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: "#B5473A", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 4 } }, lead.category || "Lead"),
                ...
                lead.phone && React.createElement("a", { href: "tel:" + lead.phone.replace(/[^\d+]/g, ""), style: { display: "flex", alignItems: "center", gap: 10, background: "#0B0E14", color: "#F5F1E8", borderRadius: 8, padding: "14px 16px", textDecoration: "none", fontWeight: 700, fontSize: 16, marginBottom: 12 } },
                    "\uD83D\uDCDE ",
                    lead.phone),
                lead.transport_needs && React.createElement("div", { style: { fontSize: 12, color: "#555", marginBottom: 4 } },
                    React.createElement("strong", null, "Needs:"),
                    " ",
                    lead.transport_needs),
                lead.pain_points && React.createElement("div", { style: { fontSize: 12, color: "#555" } },
                    React.createElement("strong", null, "Pain point:"),
                    " ",
                    lead.pain_points)),
            ...
            React.createElement("div", { style: { background: C.card, border: "1px solid " + C.border, borderRadius: 10, padding: "14px 16px" } },
                React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: C.dim, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 } },
                    ...
                    callerName),
                React.createElement("textarea", { value: note, onChange: function (e) { setNote(e.target.value); }, placeholder: "Notes (optional)...", rows: 2, style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 8, color: C.white, padding: "10px 12px", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box", resize: "vertical", marginBottom: 10 } }),
    ...
    return React.createElement("div", { style: { maxWidth: 720, margin: "0 auto" } },
        React.createElement("div", { style: { fontSize: 18, fontWeight: 900, color: C.white, marginBottom: 4 } }, "\uD83D\uDCCB Leads Board"),
        ...
        React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 } }, paged.map(function (lead) {
            ...
            return React.createElement("div", { key: lead.id, onClick: function () { setSelected(lead.id); }, style: { background: C.card, border: "1px solid " + C.border, borderRadius: 9, padding: "12px 14px", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 } },
...
function PayrollDashboard(props) {
    ...
    var repEarnings = {};
    var dispatchUsers = users.filter(function (u) { return u.role !== "driver" && u.id !== "potent"; });
    dispatchUsers.forEach(function (u) {
        var userRate = rates[u.id] !== undefined ? rates[u.id] : u.commission || 0.125;
        var myJobs = jobs.filter(function (j) {
            var rep = j.salesperson || j.createdBy || "";
            return rep === u.name && (j.status === "Paid" || j.status === "Completed") && (j.date || "") >= rangeStart;
        });
        var revenue = myJobs.reduce(function (s, j) { return s + (j.finalPrice || 0); }, 0);
        var commission = Math.round(revenue * userRate * 100) / 100;
        var paidKey = u.id + "_" + period;
        var alreadyPaid = paid[paidKey] || 0;
        var outstanding = Math.max(0, commission - alreadyPaid);
        repEarnings[u.id] = { user: u, rate: userRate, jobs: myJobs.length, revenue, commission, alreadyPaid, outstanding };
    });
    ...
    function saveRate(userId, val) {
        var newRates = Object.assign({}, rates);
        newRates[userId] = Number(val);
        setRates(newRates);
        try {
    ...
    return React.createElement("div", { style: { maxWidth: 760, margin: "0 auto" } },
        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10, marginBottom: 4 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6 } },
                React.createElement("button", { onClick: function () { setEditRates(!editRates); }, style: { border: "1px solid " + C.border, borderRadius: 7, padding: "6px 12px", cursor: "pointer", background: "transparent", color: editRates ? C.orange : C.dim, fontWeight: 700, fontFamily: "inherit", fontSize: 11 } }, editRates ? "✓ Done Editing" : "✏ Edit Rates"))),
                ...
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr auto", gap: 12, alignItems: "start" } },
                    React.createElement("div", null,
                        React.createElement("div", { style: { fontSize: 14, fontWeight: 800, color: C.white, marginBottom: 4 } },
                            ...
                            " ",
                            rep.user.name),
                        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(100px,1fr))", gap: 8, marginBottom: 10 } }, [["Jobs Booked", rep.jobs, C.white], ["Revenue", "$" + rep.revenue.toLocaleString(), C.orange], ["Rate", Math.round(rep.rate * 100) + "%", C.blue], ["Commission", "$" + rep.commission.toLocaleString(), C.green], ["Paid", "$" + rep.alreadyPaid.toLocaleString(), C.dim], ["Outstanding", "$" + rep.outstanding.toLocaleString(), rep.outstanding > 0 ? C.red : C.green]].map(function (s) {
                        ...
                        editRates && React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 8 } },
                            React.createElement("span", { style: { fontSize: 11, color: C.dim } }, "Commission rate:"),
                            React.createElement("select", { value: rates[rep.user.id] !== undefined ? rates[rep.user.id] : rep.user.commission, onChange: function (e) { saveRate(rep.user.id, e.target.value); }, style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 6, color: C.white, padding: "4px 8px", fontSize: 12, outline: "none", fontFamily: "inherit", colorScheme: "dark" } }, [0.05, 0.08, 0.10, 0.125, 0.13, 0.15, 0.175, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50].map(function (r) { return React.createElement("option", { key: r, value: r }, Math.round(r * 100) + "%"); }))),
                        rep.outstanding > 0 && React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } },
                            React.createElement("input", { type: "number", value: payAmount, onChange: function (e) { setPayAmount(e.target.value); }, placeholder: "Amount (max $" + rep.outstanding.toLocaleString() + ")", style: { background: C.surface, border: "1px solid " + C.border, borderRadius: 7, color: C.white, padding: "7px 10px", fontSize: 12, outline: "none", fontFamily: "inherit", width: 200 } }),
                            React.createElement(Btn, { onClick: function () { if (!payAmount)
                                    return; markPaid(rep.user.id, payAmount); setPayAmount(""); }, style: { fontSize: 12, padding: "7px 14px" } }, "\u2713 Mark Paid"),
