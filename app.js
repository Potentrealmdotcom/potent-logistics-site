...
function LeadsBoard(props) {
    ...
    var [composeEmail, setComposeEmail] = useState({to:"",subject:"POTENT Logistics — Following Up",body:""});
    React.useEffect(function(){
        setShowCompose(false);
        var l = leads.find(function(x){ return x.id===selected; });
        setComposeEmail({to: l&&l.email?l.email:"", subject:"POTENT Logistics — Following Up", body: l ? "Hi " + (l.name||"there") + ",\n\nI wanted to follow up regarding your transportation and logistics needs.\n\nWe specialize in same-day freight, delivery, and junk removal in the Atlanta/Georgia area with live GPS tracking on every job.\n\nWould love to connect — feel free to call us at (770) 648-4228 or reply here.\n\nBest,\n" + callerName + "\nPOTENT Logistics" : ""});
    }, [selected]);
    ...
    if (selected) {
        ...
        return React.createElement("div", { style: { maxWidth: 560, margin: "0 auto" } },
            ...
            React.createElement("div", { style: { background: "#F5F1E8", color: "#0B0E14", borderRadius: 12, padding: "20px", marginBottom: 16 } },
                ...
                React.createElement("div", { style: { display: "flex", gap: 8, marginBottom: 12 } },
                    lead.phone && React.createElement("a", { href: "tel:" + lead.phone.replace(/[^\d+]/g, ""), style: { flex: 1, display: "flex", alignItems: "center", gap: 8, background: "#0B0E14", color: "#F5F1E8", borderRadius: 8, padding: "12px 14px", textDecoration: "none", fontWeight: 700, fontSize: 14 } },
                        "\uD83D\uDCDE ", lead.phone),
                    lead.phone && React.createElement("a", { href: "https://voice.google.com/calls?a=nc," + lead.phone.replace(/[^\d+]/g, ""), target: "_blank", rel: "noopener", title: "Call via Google Voice", style: { display: "flex", alignItems: "center", justifyContent: "center", background: "#1a7f37", color: "#fff", borderRadius: 8, padding: "12px 14px", textDecoration: "none", fontWeight: 700, fontSize: 12, whiteSpace: "nowrap" } },
                        "\uD83D\uDCF1 G-Voice"),
                    lead.email && React.createElement("a", { href: "https://mail.google.com/mail/u/0/#search/" + encodeURIComponent("from:" + lead.email + " OR to:" + lead.email), target: "_blank", rel: "noopener", title: "View emails from this lead in Gmail", style: { display: "flex", alignItems: "center", justifyContent: "center", background: "#c5221f", color: "#fff", borderRadius: 8, padding: "12px 14px", textDecoration: "none", fontWeight: 700, fontSize: 12, whiteSpace: "nowrap" } },
                        "\uD83D\uDCE5 Inbox")),
            ...
            React.createElement("div", { style: { background: C.card, border: "1px solid " + C.border, borderRadius: 10, padding: "14px 16px", marginBottom: 14 } },
                React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } },
                    React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: C.dim, textTransform: "uppercase", letterSpacing: 1 } }, "\uD83D\uDCE7 Send Email"),
                    lead.email && React.createElement("a", { href: "https://mail.google.com/mail/u/0/#search/" + encodeURIComponent("from:" + lead.email + " OR to:" + lead.email), target: "_blank", rel: "noopener", style: { fontSize: 10, color: C.blue, fontWeight: 700, textDecoration: "none", background: C.blue + "18", borderRadius: 5, padding: "2px 8px" } }, "\uD83D\uDCE5 View Inbox Replies")),
                React.createElement("div", { style: { fontSize: 11, color: lead.email ? C.orange : C.faint, marginBottom: 10, fontWeight: lead.email ? 600 : 400 } }, lead.email ? "To: " + lead.email : "No email on file — add one to enable email buttons."),
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 8 } }, Object.keys(LEAD_EMAIL_TEMPLATES).map(function (key) {
                ...
                React.createElement("button", { disabled: !lead.email, onClick: function () { setShowCompose(!showCompose); }, style: { width: "100%", border: "1px dashed " + (lead.email ? C.orange : C.border), borderRadius: 8, padding: "8px", cursor: lead.email ? "pointer" : "not-allowed", background: "transparent", color: lead.email ? C.orange : C.faint, fontSize: 11, fontWeight: 700, fontFamily: "inherit", marginBottom: showCompose ? 10 : 0, opacity: lead.email ? 1 : 0.5 } }, showCompose ? "\u2715 Close Compose" : "\u270F Write Custom Email"),
                showCompose && React.createElement("div", { style: { background: C.surface, borderRadius: 8, padding: "12px" } },
                    React.createElement("div", { style: { marginBottom: 8 } },
                        React.createElement("div", { style: { fontSize: 9, color: C.dim, textTransform: "uppercase", marginBottom: 3 } }, "To"),
                        React.createElement("input", { value: composeEmail.to, onChange: function(e){ setComposeEmail(function(p){ return Object.assign({},p,{to:e.target.value}); }); }, style: { background: C.card, border: "1px solid " + C.border, borderRadius: 6, color: C.white, padding: "8px 10px", fontSize: 12, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" } })),
                    React.createElement("div", { style: { marginBottom: 8 } },
                        React.createElement("div", { style: { fontSize: 9, color: C.dim, textTransform: "uppercase", marginBottom: 3 } }, "Subject"),
                        React.createElement("input", { value: composeEmail.subject, onChange: function(e){ setComposeEmail(function(p){ return Object.assign({},p,{subject:e.target.value}); }); }, style: { background: C.card, border: "1px solid " + C.border, borderRadius: 6, color: C.white, padding: "8px 10px", fontSize: 12, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box" } })),
                    React.createElement("div", { style: { marginBottom: 8 } },
                        React.createElement("div", { style: { fontSize: 9, color: C.dim, textTransform: "uppercase", marginBottom: 3 } }, "Message"),
                        React.createElement("textarea", { value: composeEmail.body, onChange: function(e){ setComposeEmail(function(p){ return Object.assign({},p,{body:e.target.value}); }); }, rows: 6, style: { background: C.card, border: "1px solid " + C.border, borderRadius: 6, color: C.white, padding: "8px 10px", fontSize: 12, width: "100%", outline: "none", fontFamily: "inherit", boxSizing: "border-box", resize: "vertical" } })),
                    React.createElement("button", { disabled: emailSending || !composeEmail.to || !composeEmail.body, onClick: function(){
                        ...
                        fetch("https://api.emailjs.com/api/v1.0/email/send", {
                            ...
                            body: JSON.stringify({
                                ...
                                template_params: {
                                    ...
                                    from_name: callerName + " — POTENT Logistics",
                                    subject: composeEmail.subject,
                                    message: composeEmail.body,
                                    reply_to: "potentlogistics@pm.me"
                                }
                            })
                        }).then(function(){
                            setEmailMsg("\u2705 Email sent to " + composeEmail.to);
                            setEmailSending(false);
                            setShowCompose(false);
                            setTimeout(function(){ setEmailMsg(""); }, 4000);
                        }).catch(function(){
                            setEmailMsg("\u26A0 Send failed. Check EmailJS setup.");
                            setEmailSending(false);
                            setTimeout(function(){ setEmailMsg(""); }, 4000);
                        });
                    }, style: { width: "100%", background: C.orange, color: "#000", border: "none", borderRadius: 7, padding: "10px", fontSize: 13, fontWeight: 700, cursor: (emailSending || !composeEmail.to || !composeEmail.body) ? "not-allowed" : "pointer", fontFamily: "inherit", opacity: (emailSending || !composeEmail.to || !composeEmail.body) ? 0.5 : 1 } }, emailSending ? "Sending..." : "\uD83D\uDCE8 Send Email")),
                emailMsg && React.createElement("div", { style: { fontSize: 11, color: emailMsg.indexOf("\u2705") === 0 ? C.green : C.red, marginTop: 8 } }, emailMsg),
                React.createElement("div", { style: { fontSize: 9, color: C.faint, marginTop: 8, lineHeight: 1.5 } }, "Sent from potentlogistics@pm.me · Auto-sends on Follow-Up or Interested status. Team replies land in the same inbox.")),
