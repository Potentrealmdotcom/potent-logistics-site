...
var EMPLOYEE_PW = "POTENTSTAFF2026";
var ROLES = { OWNER: "owner", EMPLOYEE: "employee" };
...
function AdminDashboard(props) {
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, color: C.white, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { borderBottom: "1px solid " + C.border, padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: C.black, zIndex: 100 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                ...
                React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 1 } },
                    React.createElement("div", { style: { fontSize: 9, color: props.role === ROLES.OWNER ? C.orange : C.green, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase" } }, props.role === ROLES.OWNER ? "👑 Owner" : "👤 Dispatch Staff"),
        ...
        React.createElement("div", { style: { padding: "20px 14px 60px", maxWidth: 740, margin: "0 auto" } },
            tab === "quote" && React.createElement(PhoneQuotePanel, { onAddJob: props.onAddJob, gasPPG: props.gasPPG, role: props.role }),
...
function AdminLogin(props) {
    ...
    function go() {
        if (pw === ADMIN_PW) {
            props.onLogin(ROLES.OWNER, "Owner");
        }
        else if (pw === EMPLOYEE_PW) {
            props.onLogin(ROLES.EMPLOYEE, "Dispatch Staff");
        }
        else {
            setErr(true);
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { width: "100%", maxWidth: 340 } },
            ...
            React.createElement(Card, null,
                React.createElement("div", { style: { fontSize: 15, fontWeight: 800, color: C.white, marginBottom: 6 } }, "\uD83D\uDD10 Sign In"),
                React.createElement("div", { style: { fontSize: 11, color: C.dim, marginBottom: 16 } }, "Owner and Dispatch Staff each have separate passwords."),
                ...
                err && React.createElement("div", { style: { color: C.red, fontSize: 12, marginBottom: 10 } }, "\u26A0 Incorrect password. Check with your manager."),
...
function Root() {
    ...
    var [adminRole, setAdminRole] = useState(function () { try {
        return localStorage.getItem("pl_role") || "";
    }
    catch (e) {
        return "";
    } });
    ...
    function login(role, label) {
        setIsAdmin(true);
        setAdminRole(role);
        saveAuth(true);
        try {
            localStorage.setItem("pl_role", role);
        }
        catch (e) { }
        setShowLogin(false);
    }
    function logout() {
        ...
        saveAuth(false);
        try {
            localStorage.removeItem("pl_role");
        }
        catch (e) { }
    }
    var [showFooterTos, setShowFooterTos] = useState(false);
    if (isAdmin)
        return React.createElement(AdminDashboard, { jobs: jobs, onUpdateStatus: updateJob, onAddJob: addJob, onLogout: logout, gasPPG: gasPPG, blockedDates: blockedDates, onToggleBlock: toggleBlockDate, role: adminRole });
    if (showLogin)
