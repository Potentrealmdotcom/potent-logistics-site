...
// employee manager) and stored here — this way "Dispatch 1" can become
// "Marcus" without editing source code, and both screens stay in sync.
var NAME_OVERRIDES_KEY = "pl_emp_settings"; // shares storage with Payroll's empSettings
...
function Root() {
    ...
    if (isAdmin)
        return React.createElement(AdminDashboard, { jobs: jobs, onUpdateStatus: updateJob, onAddJob: addJob, onLogout: logout, gasPPG: gasPPG, dieselPPG: dieselPPG, blockedDates: blockedDates, onToggleBlock: toggleBlockDate, role: adminRole, currentUser: currentUser });
    if (showLogin)
    ...
    return React.createElement("div", { style: { maxWidth: 720, margin: "0 auto" } },
        showAddLead && React.createElement("div", { onClick: function (e) { if (e.target === e.currentTarget)
            ...
            React.createElement("div", { style: { background: C.card, borderRadius: 14, width: "100%", maxWidth: 480, maxHeight: "90vh", overflowY: "auto", padding: "20px" } },
                ...
                React.createElement(TxtIn, { label: "Service / Transport Needs", value: newLead.service_type, onChange: function (v) { setNewLeadField("service_type", v); }, placeholder: "What do they need moved/hauled?", rows: 2 }),
                React.createElement(TxtIn, { label: "Notes", value: newLead.notes, onChange: function (v) { setNewLeadField("notes", v); }, placeholder: "Pain points, context, anything useful for the next call...", rows: 2 }),
