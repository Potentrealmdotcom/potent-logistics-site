        ...
        React.createElement("div", { style: { background: C.card, borderRadius: 14, width: "100%", maxWidth: 540, maxHeight: "90vh", overflowY: "auto", fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
            ...
            React.createElement("div", { style: { padding: "18px 20px" } },
                ...
                React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 14 } },
                    React.createElement("div", { onClick: function () { set("support_plan", !f.support_plan); }, style: { width: 20, height: 20, borderRadius: 5, background: f.support_plan ? C.orange : "transparent", border: "1.5px solid " + (f.support_plan ? C.orange : C.border), display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "#000", fontWeight: 800, cursor: "pointer" } }, f.support_plan ? "✓" : ""),
                    React.createElement("div", { style: { fontSize: 12, color: C.dim } },
                        "Include support plan at $",
                        f.support_price,
                        "/mo")),
                React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 12px" } },
...
function Root() {
    ...
    var isPOSAdmin = typeof window !== "undefined" && window.location.search.indexOf("potent-os-admin") > -1;
    var isWaitlist = typeof window !== "undefined" && (window.location.search.indexOf("apply") > -1 || window.location.pathname.indexOf("apply") > -1);
    if (isPOSAdmin)
