...
// ── USER ACCOUNTS ─────────────────────────────────────────────────────
var USERS = [
    { id: "potent", name: "POTENT", role: "owner", password: "POTENTADMIN0421", emoji: "👑", access: ["quote", "jobs", "exceptions", "reports", "advanced", "carriers", "expenses", "accounts", "sales", "audit", "calendar", "driver", "driverapp", "ai", "demo", "leads", "activity"] },
    { id: "dispatch1", name: "Dispatch 1", role: "dispatch", password: "DISPATCH1PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads"] },
    { id: "dispatch2", name: "Dispatch 2", role: "dispatch", password: "DISPATCH2PL", emoji: "📞", access: ["quote", "jobs", "calendar", "driver", "driverapp", "leads"] },
    ...
    return React.createElement("div", { style: { minHeight: "100vh", background: C.black, color: C.white, fontFamily: "'DM Sans','Segoe UI',sans-serif" } },
        React.createElement("div", { style: { borderBottom: "1px solid " + C.border, padding: "13px 18px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: C.black, zIndex: 100 } },
            ...
            React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center" } },
                React.createElement("div", { style: { display: "flex", gap: 3, background: C.surface, borderRadius: 9, padding: 3, flexWrap: "wrap" } }, [["quote", "📞 Quote"], ["jobs", "📋 Jobs"], ["exceptions", "🚨 Alerts"], ["reports", "📊 Reports"], ["advanced", "📈 Analytics"], ["carriers", "🤝 Carriers"], ["expenses", "💸 Expenses"], ["accounts", "🏢 Accounts"], ["sales", "🏆 Sales"], ["audit", "👁 Audit"], ["calendar", "📅 Cal"], ["driver", "🚐 Driver"], ["driverapp", "🚐 Driver App"], ["ai", "🤖 AI Docs"], ["leads", "📋 Leads"], ["activity", "👥 Activity"], ["demo", "🎬 Demo"]].filter(function (item) {
...
A Potent Prädəkt® Company · Private access by application only · 3 slots available this month
</div>
</body></html>`;
...
<div class="footer">
<strong>POTENT OS</strong> · potentoperations.netlify.app · (770) 648-4228 · A Potent Prädəkt® Company<br>
...
A Potent Prädəkt® Company · This report was generated from your answers. Actual savings may vary.
</div>
</body></html>`;
    var blob = new Blob([content], { type: "text/html" });
    var url = URL.createObjectURL(blob);
