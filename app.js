...
var SEED = [
    ...
    { id: "PL-260616-E5F6", customer: "Devon Price", phone: "678-555-0887", service: "event", serviceName: "Event Drop-Off", origin: "Conyers, GA", destination: "Augusta, GA", zone: "regional", speed: "afterhours", basePrice: 700, finalPrice: 1120, status: "Confirmed", payment: "cashapp", discreet: false, isBusiness: false, date: "2026-06-16", notes: "Vendor booth + 12 boxes", helperHours: 0, fuel: 78 },
    { id: "PL-260617-G7H8", customer: "Renee Okafor", phone: "404-555-0299", service: "discreet", serviceName: "Discreet Transport", origin: "Atlanta, GA", destination: "Savannah, GA", zone: "longdist", speed: "standard", basePrice: 1800, finalPrice: 1800, status: "Confirmed", payment: "wire", discreet: true, isBusiness: true, date: "2026-06-17", notes: "Art pieces — fragile", helperHours: 0, fuel: 120 },
];
    ...
    try {
        fetch("https://api.emailjs.com/api/v1.0/email/send", { method: "POST", headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ service_id: "YOUR_SERVICE_ID", template_id: "YOUR_TEMPLATE_ID", user_id: "YOUR_PUBLIC_KEY",
                template_params: { to_email: BUSINESS_EMAIL, job_id: job.id, customer: job.customer, phone: job.phone,
...
function StripeCardForm(props) {
    var sErr = (0, react_1.useState)("");
    var cardError = sErr[0];
    var setCardError = sErr[1];
    var sProc = (0, react_1.useState)(false);
    var processing = sProc[0];
    var setProcessing = sProc[1];
    var sStripe = (0, react_1.useState)(null);
    var stripe = sStripe[0];
    var setStripe = sStripe[1];
    var sCard = (0, react_1.useState)(null);
    var cardEl = sCard[0];
    var setCardEl = sCard[1];
    var sReady = (0, react_1.useState)(false);
    var ready = sReady[0];
...
function TrackerView(props) {
    var jobs = props.jobs;
    var [input, setInput] = (0, react_1.useState)("");
    var [job, setJob] = (0, react_1.useState)(null);
    var [err, setErr] = (0, react_1.useState)("");
    function search() {
...
function BookingView(props) {
    var [step, setStep] = (0, react_1.useState)(1);
    var [svc, setSvc] = (0, react_1.useState)(null);
    var [form, setForm] = (0, react_1.useState)({ name: "", phone: "", origin: "", destination: "", pickupCity: "", dropoffCity: "", zone: props.preZone || "local", speed: "standard", itemSize: "", helper: false, weightTier: "light", extraStop: false, readyConfirm: false, isBusiness: false, payment: "cash", discreet: false, notes: "", date: "", timeSlot: "" });
    var [quote, setQuote] = (0, react_1.useState)(null);
    var [jobId, setJobId] = (0, react_1.useState)(null);
    var [showCardForm, setShowCardForm] = (0, react_1.useState)(false);
...
function CalendarView(props) {
    var jobs = props.jobs;
    var today = new Date();
    var [month, setMonth] = (0, react_1.useState)(today.getMonth());
    var [year, setYear] = (0, react_1.useState)(today.getFullYear());
    var [selDay, setSelDay] = (0, react_1.useState)(null);
...
function DriverPanel(props) {
    ...
    var [sel, setSel] = (0, react_1.useState)((active[0] && active[0].id) || null);
    var [timers, setT] = (0, react_1.useState)({});
    (0, react_1.useEffect)(function () {
        var iv = setInterval(function () {
            setT(function (t) {
...
function NewJobModal(props) {
    var [f, setF] = (0, react_1.useState)({ customer: "", phone: "", origin: "", destination: "", pickupCity: "", dropoffCity: "", serviceId: "delivery", zone: "local", speed: "standard", payment: "cash", discreet: false, notes: "", helper: false, weightTier: "light", priceTier: "standard", helperHours: "0", fuel: "30" });
...
function JobsDashboard(props) {
    ...
    var [filter, setFilter] = (0, react_1.useState)("All");
    var [sel, setSel] = (0, react_1.useState)(null);
    var [showNew, setShowNew] = (0, react_1.useState)(false);
    var [search, setSearch] = (0, react_1.useState)("");
...
function OOSBookingView(props) {
    ...
    var setForm = sf[1];
    function set(k, v) { setForm(function (f) { var n = Object.assign({}, f); n[k] = v; return n; }); }
    var sq = (0, react_1.useState)(null);
    var quote = sq[0];
    var setQuote = sq[1];
    var sj = (0, react_1.useState)(null);
    var jobId = sj[0];
    var setJobId = sj[1];
    var se = (0, react_1.useState)("");
    var err = se[0];
    var setErr = se[1];
    var ss = (0, react_1.useState)(1);
    var step = ss[0];
    var setStep = ss[1];
    var scf = (0, react_1.useState)(false);
...
function PhoneQuotePanel(props) {
    ...
    var sc = (0, react_1.useState)(false);
    var confirmed = sc[0];
...
function AdminDashboard(props) {
    var [tab, setTab] = (0, react_1.useState)("quote");
...
function AdminLogin(props) {
    var [pw, setPw] = (0, react_1.useState)("");
    var [err, setErr] = (0, react_1.useState)(false);
    function go() {
        if (pw === ADMIN_PW) {
            props.onLogin();
        }
...
function PublicApp(props) {
    var [tab, setTab] = (0, react_1.useState)("home");
    var [bookCity, setBookCity] = (0, react_1.useState)(null);
...
// ── ROOT ──────────────────────────────────────────────────────────
function Root() {
    var [jobs, setJobs] = (0, react_1.useState)(loadJobs);
    var [isAdmin, setIsAdmin] = (0, react_1.useState)(loadAuth);
    var [showLogin, setShowLogin] = (0, react_1.useState)(false);
    var [gasPPG, setGasPPG] = (0, react_1.useState)(FALLBACK_GAS);
    var [blockedDates, setBlockedDates] = (0, react_1.useState)(function () {
        try {
    ...
    (0, react_1.useEffect)(function () { saveJobs(jobs); }, [jobs]);
    (0, react_1.useEffect)(function () {
        try {
